...
<div id="left">
<p> This tab contains historical infomation about  registers since january 2019, the app will return automatically the hole dataset for 2019 and 2020 which is expected to be update by the website every month.There is a filter update that will change the graph by selecting the range of dates. </p>
</div>

## {}
<h1 style="border:2px solid DodgerBlue;">Date</h1>
<p>
The first graph allows to see the series interactively by month, the last 6 months, 1 year from the last date, one year calendar, and all the records by selecting the buttons above it. You can also check the total number of accidents, victims and percentage of accidents based on the day on the week that they occured and the injury level. </p>
...
## {}
<h1 style="border:2px solid DodgerBlue;">Modules</h1>
